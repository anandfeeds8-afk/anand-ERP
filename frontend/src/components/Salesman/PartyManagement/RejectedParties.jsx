...
const RejectedParties = ({ party }) => {
  ...
  return (
    <div className="shadow bg-white rounded-lg lg:p-4 md:p-4 sm:p-3 p-3lg:flex lg:flex-col justify-between hover:shadow-md transition-all">
...
export default RejectedParties;
