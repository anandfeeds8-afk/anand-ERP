      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          ...
          {party?.partyStatus === "pending" && (
            <p className="text-orange-700 dark:text-orange-200 dark:bg-orange-800 font-semibold text-[10px] lg:text-xs p-1 px-2 bg-orange-100 rounded-full">
              Pending
            </p>
          )}
          {party?.partyStatus === "sentForApproval" && (
            <p className="text-violet-700 dark:text-violet-200 dark:bg-violet-800 font-semibold text-[10px] lg:text-xs p-1 px-2 bg-violet-100 rounded-full">
              Sent for approval
            </p>
          )}
          {party?.partyStatus === "rejected" && (
            <p className="text-red-700 dark:text-red-200 dark:bg-red-800 font-semibold text-[10px] lg:text-xs p-1 px-2 bg-red-100 rounded-full">
              Rejected
            </p>
          )}
        </div>
