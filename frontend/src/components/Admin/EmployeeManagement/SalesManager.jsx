...
const SalesManager = ({ item }) => {
  const { _id } = item;
  const { deleteSalesManager, isLoading, updateSalesManager } = useEmployees();
  ...
  return (
    ...
    >
          ...
          <div className="bg-white p-7 rounded-lg w-[29rem]">
            ...
            <div className="flex items-center justify-end gap-3 mt-5">
              ...
              <Button
                ...
                color="error"
                sx={{ textTransform: "none" }}
                onClick={() => deleteSalesManager(item._id)}
              >
                Delete
              </Button>
            </div>
      ...
      {openEdit && (
        <div className="transition-all bg-gradient-to-b from-black/20 to-black/60 backdrop-blur-sm w-full z-50 h-screen absolute top-0 left-0 flex items-center justify-center">
          <div className="bg-white p-7 rounded-lg w-[29rem]">
            <p className="text-xl font-semibold mb-7">Edit Sales Manager</p>
