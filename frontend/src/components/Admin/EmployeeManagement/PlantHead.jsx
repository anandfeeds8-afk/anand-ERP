...
const PlantHead = ({ item, getPlantHeadStats }) => {
  const { _id } = item;
  const { deletePlantHead, isLoading, updatePlantHead } = useEmployees();
  ...
  useEffect(() => {
    const stats = getPlantHeadStats(_id);
    setOrderStats(stats);
  }, [_id]);
    ...
    >
      ...
      {openDelete && (
        <div className="transition-all bg-gradient-to-b from-black/20 to-black/60 backdrop-blur-sm w-full z-50 h-screen absolute top-0 left-0 flex items-center justify-center">
          <div className="bg-white dark:bg-gray-800 lg:p-7 p-5 rounded-lg sm:w-[60%] lg:w-[29rem] md:w-[50%] w-[95%]">
            ...
            <div className="flex items-center justify-end gap-3 mt-5">
              ...
              <Button
                ...
                color="error"
                sx={{ textTransform: "none" }}
                onClick={() => deletePlantHead(item._id)}
              >
                Delete
              </Button>
            </div>
      ...
      {openView && (
        <div className="transition-all bg-gradient-to-b from-black/20 to-black/60 backdrop-blur-sm w-full z-50 h-screen absolute top-0 left-0 flex items-center justify-center">
          <div className="bg-white dark:bg-gray-800 relative lg:p-7 p-5 sm:w-[60%] rounded-lg lg:w-[40rem] md:w-[50%] w-[95%] grid">
            <div>
